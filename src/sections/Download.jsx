                            ...
                            <ul className="flex flex-wrap items-center gap-6">
                                {links.map(({id, url, icon}) => (
                                    ...
                                    >
                                        <a 
                                            href={url}
                                            className="size-22 donwload_tech-icon_before relative flex items-center justify-center rounded-half border-2 border-s3 bg-s1 transition-border-color duration-500"
                                        >
